...
const Brand = () => {
    const BrnadList = [
        { Brand: "Polycab", Status: "Active" },
        { Brand: "RR Kabel", Status: "Active" },
        { Brand: "KEI", Status: "Active" },
        { Brand: "SouthWier ", Status: "Active" },
        { Brand: "Litost ", Status: "Active" },
        { Brand: "girishswitches ", Status: "Active" },
        { Brand: "Sri Sagar ", Status: "Active" },
        { Brand: "Anchor ", Status: "Active" },
        { Brand: "Legrand India ", Status: "Active" },
    ];
    const [brandList, setBrandList] = useState();
    useEffect(() => {
        setBrandList(BrnadList);
    }, [])
    return (
        <>
